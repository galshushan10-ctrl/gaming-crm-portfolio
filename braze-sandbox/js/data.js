...
BZ.campaigns = [
  {
    ...
    campaignType: 'Email', entrySchedule: 'Action-Based', stopDate: null,
    ...
    createdBy: 'Maya (CRM)', updated: daysFromNow(-3), tags: ['01_Level_L2', '05_Tracking_Test_Control', '06_Audience_General', '07_Geo_Global', '08_Incentive_No_Reward'],
  },
  {
    id: 'cmp-prearrival', name: 'Pre-arrival — check-in online', status: 'active',
    campaignType: 'Multichannel', entrySchedule: 'Action-Based', stopDate: null,
    ...
    createdBy: 'Maya (CRM)', updated: daysFromNow(-11), tags: ['01_Level_L1', '05_Tracking_None', '06_Audience_General', '07_Geo_Global', '09_Lifecycle_PreArrival'],
  },
  {
    id: 'cmp-summer', name: 'Summer Escapes — Eilat & Dead Sea', status: 'idle',
    campaignType: 'Email', entrySchedule: 'One Time', stopDate: daysFromNow(-19),
    ...
    createdBy: 'Omer (Growth)', updated: daysFromNow(-26), tags: ['01_Level_L4', '05_Tracking_Test_Control', '06_Audience_Closed List', '07_Geo_IL', '08_Incentive_Discount'],
  },
  {
    id: 'cmp-points', name: 'Points expiring in 30 days', status: 'active',
    campaignType: 'Email', entrySchedule: 'Recurring', stopDate: null,
    channels: ['Email'], deliveryType: 'scheduled',
    ...
    createdBy: 'Maya (CRM)', updated: daysFromNow(-2), tags: ['01_Level_L3', '05_Tracking_None', '06_Audience_General', '07_Geo_Global', '08_Incentive_Points'],
  },
  {
    ...
    createdBy: 'Maya (CRM)', updated: daysFromNow(-40), tags: ['01_Level_L1', '05_Tracking_None', '06_Audience_General', '07_Geo_Global', '09_Lifecycle_PostStay'],
  },
  {
    id: 'cmp-nyx', name: 'NYX Urban — city break flash sale', status: 'draft',
    campaignType: 'Multichannel', entrySchedule: 'One Time', stopDate: null,
    ...
    stats: { sent: 0, delivered: 0, opens: 0, clicks: 0, conversions: 0, revenue: 0, unsubscribes: 0, bounces: 0 },
    createdBy: 'Omer (Growth)', updated: daysFromNow(-1), tags: ['01_Level_L4', '05_Tracking_None', '06_Audience_Closed List', '07_Geo_EU', '08_Incentive_Discount'],
  },
  {
    id: 'cmp-winback-old', name: 'Win-back Q1 — 20% off', status: 'stopped',
    campaignType: 'Email', entrySchedule: 'One Time', stopDate: daysFromNow(-158),
    channels: ['Email'], deliveryType: 'scheduled',
    ...
    createdBy: 'Maya (CRM)', updated: daysFromNow(-172), tags: ['01_Level_L4', '05_Tracking_Test_Control', '06_Audience_General', '07_Geo_Global', '08_Incentive_Discount'],
  },
];
